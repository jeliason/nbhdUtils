...
cell_types = c("CD11c+ DCs","CD8+ T cells","Tregs","tumor cells","vasculature")
pseudospace_plot(nbhds.obj, clusters = clust$clusters,
                 against = "CD8+ T cells",
                 cell_types = cell_types)


celltype_pairsplot(nbhds.obj, clust$clusters, columns = cell_types)
...
ord = decorana(nbhds)
set.seed(2022)
ord = metaMDS(nbhds, maxit = 400, k=2)

res <- list(rows = ord$rproj, cols = ord$cproj)
