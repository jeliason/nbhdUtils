...
```{r}
df_rashid = read_csv('../data/spatial_multiplex_rashid_2019/data/LUNG-1-LN_40X_master.csv')
mat = df_rashid[,4:47]%>%
  as.matrix
...
df_rashid$cell_type = out


Xmin = min(df_rashid$X_position) - 1
# Xmax = max(df$X_position) + 1
Xmax = 2000
# Ymin = min(df$Y_position) - 1
Ymin = 8000
Ymax = max(df_rashid$Y_position) + 1
